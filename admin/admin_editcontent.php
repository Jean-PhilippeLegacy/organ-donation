    ...
    <section class="grey-container map">
        ...
        <div class="row expanded collapse">
            <div class="small-12 float-left column">
                ...
                <input class="inputContent1 small-12 end column" type="text" name="section1" maxlength="4" value="<?php echo $populateContent['content_section_one']; ?>"></span>
        ...
        <div class="row expanded collapse">
            ...
            <div class="white-bg small-12 medium-6 large-6 column crcl">
                ...
                <p><?php echo $populateContent['content_circle1_text1']; ?></p>
         		<input class="bebas" type="text" name="circle1" maxlength="3" value="<?php echo $populateContent['content_circle1_stat']; ?>">
         		<p> <?php echo $populateContent['content_circle1_text2']; ?></p>

         		<p><?php echo $populateContent['content_circle2_text1']; ?></p>
         		<input class="bebas" type="text" name="circle2" maxlength="2" value="<?php echo $populateContent['content_circle2_stat']; ?>">
         		<p><?php echo $populateContent['content_circle2_text2']; ?></p>

         		<p><?php echo $populateContent['content_circle3_text1']; ?></p>
         		<input class="bebas" type="text" name="circle3" maxlength="2" value="<?php echo $populateContent['content_circle3_stat']; ?>">
         		<p><?php echo $populateContent['content_circle3_text2']; ?></p>

         		<p><?php echo $populateContent['content_circle4_text1']; ?></p>
         		<br><input class="bebas" type="text" name="circle4" maxlength="3" value="<?php echo $populateContent['content_circle4_stat']; ?>">
         		<p> <?php echo $populateContent['content_circle4_text2']; ?></p>

         		<p><?php echo $populateContent['content_circle5_text1']; ?></p>
         		<input class="bebas" type="text" name="circle5" maxlength="2" value="<?php echo $populateContent['content_circle5_stat']; ?>">
         		<p> <?php echo $populateContent['content_circle5_text2']; ?></p>

         		<p><?php echo $populateContent['content_circle6_text1']; ?></p>
         		<input class="bebas" type="text" name="circle6" maxlength="2" value="<?php echo $populateContent['content_circle6_stat']; ?>">
